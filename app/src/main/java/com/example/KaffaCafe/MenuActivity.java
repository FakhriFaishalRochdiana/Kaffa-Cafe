...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<com.example.KaffaCafe.Food> data = (ArrayList<com.example.KaffaCafe.Food>) database.getFoodList(getApplicationContext());
        RecyclerView recyclerView = findViewById(R.id.list_item_view);
        com.example.KaffaCafe.ListFoodAdapter adapter = new com.example.KaffaCafe.ListFoodAdapter(data);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout_item:
                ...
                Intent intent = new Intent(getApplicationContext(), com.example.KaffaCafe.MainActivity.class);
